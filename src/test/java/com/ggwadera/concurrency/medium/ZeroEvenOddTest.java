...
class ZeroEvenOddTest {
    ...
    void test(final int n, final String expected) throws InterruptedException {
        ...
        final Collection<Integer> result = new LinkedBlockingQueue<>();
    ...
    private List<Thread> getThreads(ZeroEvenOdd zeroEvenOdd, CountDownLatch latch, Collection<Integer> result) {
